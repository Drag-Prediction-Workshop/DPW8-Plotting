...
$!VarSet |N| = 1
$!VarSet |LFDSFN1| = '"|MACROFILEPATH|/../../../../|ScatterRepo|/TestCase1c/003_Boeing/01_OVERFLOW_Cadence_Structured_REV02_SA-neg/DPW8-AePW4_Convergence_v5.dat"'
...
$!VarSet |N| = (|NUMZONES|+1)
$!VarSet |LFDSFN2| = '"|MACROFILEPATH|/../../../../|ScatterRepo|/TestCase1c/003_Boeing/02_OVERFLOW_Cadence_Structured_REV02_SA-neg/DPW8-AePW4_Convergence_v5.dat" '
$!ReadDataSet  '|LFDSFN2|'
...
$!VarSet |N| = (|NUMZONES|+1)
$!VarSet |LFDSFN2| = '"|MACROFILEPATH|/../../../../|ScatterRepo|/TestCase1c/003_Boeing/03_OVERFLOW_Cadence_Structured_REV02_SA-neg/DPW8-AePW4_Convergence_v5.dat" '
$!ReadDataSet  '|LFDSFN2|'
  ReadDataOption = Append
  ResetStyle = No
  VarLoadMode = ByName
...
$!VarSet |N| = (|NUMZONES|+1)
$!VarSet |LFDSFN2| = '"|MACROFILEPATH|/../../../../|ScatterRepo|/TestCase1c/003_Boeing/04_FELight_Cadence_Unstructured_REV02_SA-neg/DPW8-AePW4_Convergence_v5.dat" '
$!ReadDataSet  '|LFDSFN2|'
  ReadDataOption = Append
  ResetStyle = No
  VarLoadMode = ByName
...
$!VarSet |N| = (|NUMZONES|+1)
$!VarSet |LFDSFN2| = '"|MACROFILEPATH|/../../../../|ScatterRepo|/TestCase1c/003_Boeing/05_FELight_HeldenMesh_Unstructured_REV02_SA-neg/DPW8-AePW4_Convergence_v5.dat" '
$!ReadDataSet  '|LFDSFN2|'
  ReadDataOption = Append
  ResetStyle = No
  VarLoadMode = ByName
...
$!VarSet |N| = (|NUMZONES|+1)
$!VarSet |LFDSFN2| = '"|MACROFILEPATH|/../../../../|ScatterRepo|/TestCase1c/012_NASA_LARC_AB/01_FUN3D_NCFV_Cadence/DPW8-AePW4_Convergence_v5.dat" '
$!ReadDataSet  '|LFDSFN2|'
  ReadDataOption = Append
  ResetStyle = No
  VarLoadMode = ByName
...
$!VarSet |N| = (|NUMZONES|+1)
$!VarSet |LFDSFN2| = '"|MACROFILEPATH|/../../../../|ScatterRepo|/TestCase1c/012_NASA_LARC_AB/02_FUN3D_SFE_Cadence/DPW8-AePW4_Convergence_v5.dat" '
$!ReadDataSet  '|LFDSFN2|'
  ReadDataOption = Append
  ResetStyle = No
  VarLoadMode = ByName
...
$!VarSet |N| = (|NUMZONES|+1)
$!VarSet |LFDSFN2| = '"|MACROFILEPATH|/../../../../|ScatterRepo|/TestCase1c/012_NASA_LARC_AB/03_FUN3D_NCFV_Helden/DPW8-AePW4_Convergence_v5.dat" '
$!ReadDataSet  '|LFDSFN2|'
  ReadDataOption = Append
  ResetStyle = No
  VarLoadMode = ByName
...
$!VarSet |N| = (|NUMZONES|+1)
$!VarSet |LFDSFN2| = '"|MACROFILEPATH|/../../../../|ScatterRepo|/TestCase1c/012_NASA_LARC_AB/04_FUN3D_SFE_Helden/DPW8-AePW4_Convergence_v5.dat" '
$!ReadDataSet  '|LFDSFN2|'
  ReadDataOption = Append
  ResetStyle = No
  VarLoadMode = ByName
...
$!VarSet |N| = (|NUMZONES|+1)
$!VarSet |LFDSFN2| = '"|MACROFILEPATH|/../../../../|ScatterRepo|/TestCase1c/012_NASA_LARC_AB/05_FUN3D_NCFV_Adapt/DPW8-AePW4_Convergence_v5.dat" '
$!ReadDataSet  '|LFDSFN2|'
  ReadDataOption = Append
  ResetStyle = No
  VarLoadMode = ByName
...
$!VarSet |N| = (|NUMZONES|+1)
$!VarSet |LFDSFN2| = '"|MACROFILEPATH|/../../../../|ScatterRepo|/TestCase1c/012_NASA_LARC_AB/06_FUN3D_SFE_Adapt/DPW8-AePW4_Convergence_v5.dat" '
$!ReadDataSet  '|LFDSFN2|'
  ReadDataOption = Append
  ResetStyle = No
  VarLoadMode = ByName
...
$!VarSet |N| = (|NUMZONES|+1)
$!VarSet |LFDSFN2| = '"|MACROFILEPATH|/../../../../|ScatterRepo|/TestCase1c/040_QinetiQ/01_FLUENT_ONERA-OAT15A_Cadence_Unstructured_REV02_SA/DPW8-AePW4_Convergence_v5.dat" '
$!ReadDataSet  '|LFDSFN2|'
  ReadDataOption = Append
  ResetStyle = No
  VarLoadMode = ByName
...
$!VarSet |N| = (|NUMZONES|+1)
$!VarSet |LFDSFN2| = '"|MACROFILEPATH|/../../../../|ScatterRepo|/TestCase1c/040_QinetiQ/02_FLUENT_ONERA-OAT15A_Cadence_Structured_REV02_SA/DPW8-AePW4_Convergence_v5.dat" '
$!ReadDataSet  '|LFDSFN2|'
  ReadDataOption = Append
  ResetStyle = No
  VarLoadMode = ByName
...
$!LOOP |NUMZONES|
  ...
  $!IF 0 == 1
   $!AlterData  [|LOOP|]
       IgnoreDivideByZero = Yes
       Equation = '{ContimuityMod} = V4 / |ResidContfinal| * 1E-16'
  $!ENDIF
  #--------------
$!ENDLOOP
...
$!XYLineAxis YDetail 1 { CoordScale = Log    RangeMin = 1E-16  RangeMax = 1E+2  GRSpacing = 1E+2 Title{Offset = 8} Gridlines{Show = Yes} MinorGridlines{Show = No }}
...
$!LineMap [7-12]  Lines{Color = Custom3 LineThickness = 0.40}
$!LineMap [70-75] Lines{Color = Blue LineThickness = 0.40}
$!LineMap [76-81] Lines{Color = Blue LineThickness = 0.40}
...
$!LineMap [1-|NumLineMaps|]  Assign{YAxisVar = 7}
$!XYLineAxis XDetail 1 { CoordScale = Log    RangeMin = 1E-9    RangeMax = 1E-1                       Title{Offset = 6} Gridlines{Show = Yes} MinorGridlines{Show = Yes }}
$!XYLineAxis YDetail 1 { CoordScale = Linear RangeMin = 147.0   RangeMax = 155.0   GRSpacing = 2.0    Title{Offset = 9} Gridlines{Show = Yes} MinorGridlines{Show = Yes }}
...
$!LineMap [1-|NumLineMaps|]  Assign{YAxisVar = 7}
$!XYLineAxis XDetail 1 { CoordScale = Log    RangeMin = 1E-16   RangeMax = 1E+2                       Title{Offset = 6} Gridlines{Show = Yes} MinorGridlines{Show = Yes }}
$!XYLineAxis YDetail 1 { CoordScale = Linear RangeMin = 147.0   RangeMax = 155.0   GRSpacing = 2.0    Title{Offset = 9} Gridlines{Show = Yes} MinorGridlines{Show = Yes }}
$!XYLineAxis YDetail 1 {Gridlines{Show = No} MinorGridlines{Show = No}}
$!XYLineAxis XDetail 1 {Gridlines{Show = No} MinorGridlines{Show = No}}
$!RUNMACROFUNCTION "ExportAndSave" ( '|MACROFILEPATH|', '|Page|', '|ImageFormat|', '|ImageFormat2|' )
...
$!XYLineAxis XDetail 1 { CoordScale = Log    RangeMin = 1E-9    RangeMax = 1E-1                       Title{Offset = 6} Gridlines{Show = Yes} MinorGridlines{Show = Yes }}
$!XYLineAxis YDetail 1 { CoordScale = Linear RangeMin = 0.78    RangeMax = 0.84    GRSpacing = 0.01   Title{Offset = 9} Gridlines{Show = Yes} MinorGridlines{Show = Yes }}
$!XYLineAxis YDetail 1 {Gridlines{Show = No} MinorGridlines{Show = No}}
$!XYLineAxis XDetail 1 {Gridlines{Show = No} MinorGridlines{Show = No}}
$!RUNMACROFUNCTION "ExportAndSave" ( '|MACROFILEPATH|', '|Page|', '|ImageFormat|', '|ImageFormat2|' )
...
$!XYLineAxis XDetail 1 { CoordScale = Log    RangeMin = 1E-9    RangeMax = 1E-1                       Title{Offset = 6} Gridlines{Show = Yes} MinorGridlines{Show = Yes }}
$!XYLineAxis YDetail 1 { CoordScale = Linear RangeMin = -0.20   RangeMax = -0.10    GRSpacing = 0.02  Title{Offset = 9} Gridlines{Show = Yes} MinorGridlines{Show = Yes }}
$!XYLineAxis YDetail 1 {Gridlines{Show = No} MinorGridlines{Show = No}}
$!XYLineAxis XDetail 1 {Gridlines{Show = No} MinorGridlines{Show = No}}
$!RUNMACROFUNCTION "ExportAndSave" ( '|MACROFILEPATH|', '|Page|', '|ImageFormat|', '|ImageFormat2|' )

...
# Map01: 002.01
$!VarSet |Z| = ( |NumZones| + 1 )
$!RUNMACROFUNCTION "AppendDataSetFile" ( '"|MACROFILEPATH|/../../../../DPW8-Scatter/TestCase2b/002_Embraer/01_CFD++_Cadence-Rev00_SA/DPW8-AePW4_ForceMoment_v5.dat"' )
$!RUNMACROFUNCTION "AddLineMap" ( "SA_Maps" "CadenceUnS_Maps" )
#-------------------------------------------------
# Map02: 002.02
$!VarSet |Z| = ( |NumZones| + 1 )
$!RUNMACROFUNCTION "AppendDataSetFile" ( '"|MACROFILEPATH|/../../../../DPW8-Scatter/TestCase2b/002_Embraer/02_CFD++_Cadence-Rev00_SA-QCR/DPW8-AePW4_ForceMoment_v5.dat"' )
$!RUNMACROFUNCTION "AddLineMap" ( "SAQ_Maps"  "CadenceUnS_Maps" )
#-------------------------------------------------
# Map03: 002.03
$!VarSet |Z| = ( |NumZones| + 1 )
$!RUNMACROFUNCTION "AppendDataSetFile" ( '"|MACROFILEPATH|/../../../../DPW8-Scatter/TestCase2b/002_Embraer/03_CFD++_Cadence-Rev00_SA-QCR-RC/DPW8-AePW4_ForceMoment_v5.dat"' )
$!RUNMACROFUNCTION "AddLineMap" ( "SARCQ_Maps"  "CadenceUnS_Maps" )
#-------------------------------------------------
# Map04: 003.01
$!VarSet |Z| = ( |NumZones| + |Increment| )
$!RUNMACROFUNCTION "AppendDataSetFile" ( '"|MACROFILEPATH|/../../../../DPW8-Scatter/TestCase2b/003_Boeing/01_FELight_HeldenMesh_Unstructured_REV00_SA-neg-QCR2000/DPW8-AePW4_ForceMoment_v6.dat"' )
$!RUNMACROFUNCTION "AddLineMap" ( "SAQ_Maps" "HeldenUnSt_Maps" )
#-------------------------------------------------
# Map05: 003.02
$!VarSet |Z| = ( |NumZones| + |Increment| )
$!RUNMACROFUNCTION "AppendDataSetFile" ( '"|MACROFILEPATH|/../../../../DPW8-Scatter/TestCase2b/003_Boeing/02_FELight_Cadence_Unstructured_REV00_SA-neg-QCR2000/DPW8-AePW4_ForceMoment_v6.dat"' )
$!RUNMACROFUNCTION "AddLineMap" ( "SAQ_Maps" "CadenceUnS_Maps" )
#-------------------------------------------------
# Map06: 003.03
$!VarSet |Z| = ( |NumZones| + |Increment| )
$!RUNMACROFUNCTION "AppendDataSetFile" ( '"|MACROFILEPATH|/../../../../DPW8-Scatter/TestCase2b/003_Boeing/03_OVERFLOW_Ames_Overset_REV00_SA-neg-QCR2000/DPW8-AePW4_ForceMoment_v6.dat"' )
$!RUNMACROFUNCTION "AddLineMap" ( "SAQ_Maps" "AmesOverSt_Maps" )
#-------------------------------------------------
# Map07: 003.04
$!VarSet |Z| = ( |NumZones| + |Increment| )
$!RUNMACROFUNCTION "AppendDataSetFile" ( '"|MACROFILEPATH|/../../../../DPW8-Scatter/TestCase2b/003_Boeing/04_FELight_HeldenMesh_Unstructured_REV00_SA-neg-RC-QCR2000/DPW8-AePW4_ForceMoment_v6.dat"' )
$!RUNMACROFUNCTION "AddLineMap" ( "SARCQ_Maps" "HeldenUnSt_Maps" )
#-------------------------------------------------
# Map08: 003.05
$!VarSet |Z| = ( |NumZones| + |Increment| )
$!RUNMACROFUNCTION "AppendDataSetFile" ( '"|MACROFILEPATH|/../../../../DPW8-Scatter/TestCase2b/003_Boeing/05_FELight_Cadence_Unstructured_REV00_SA-neg-RC-QCR2000/DPW8-AePW4_ForceMoment_v6.dat"' )
$!RUNMACROFUNCTION "AddLineMap" ( "SARCQ_Maps" "CadenceUnS_Maps" )
#-------------------------------------------------
# Map09: 003.06
$!VarSet |Z| = ( |NumZones| + |Increment| )
$!RUNMACROFUNCTION "AppendDataSetFile" ( '"|MACROFILEPATH|/../../../../DPW8-Scatter/TestCase2b/003_Boeing/06_OVERFLOW_Ames_Overset_REV00_SA-neg-RC-QCR2000/DPW8-AePW4_ForceMoment_v6.dat"' )
$!RUNMACROFUNCTION "AddLineMap" ( "SARCQ_Maps" "AmesOverSt_Maps" )
#-------------------------------------------------
# Map10: 009.01
$!VarSet |Z| = ( |NumZones| + 9 )
$!RUNMACROFUNCTION "AppendDataSetFile" ( '"|MACROFILEPATH|/../../../../DPW8-Scatter/TestCase2b/009_ONERA/01_elsA_Vassberg_SA/DPW8-AePW4_ForceMoment_v5.dat"' )
$!RUNMACROFUNCTION "AddLineMap" ( "SA_Maps"  "VassbergOvrSt_Maps" )
#-------------------------------------------------
# Map11: 009.02
$!VarSet |Z| = ( |NumZones| + 9 )
$!RUNMACROFUNCTION "AppendDataSetFile" ( '"|MACROFILEPATH|/../../../../DPW8-Scatter/TestCase2b/009_ONERA/02_elsA_Vassberg_SA-QCR2000/DPW8-AePW4_ForceMoment_v5.dat"' )
$!RUNMACROFUNCTION "AddLineMap" ( "SAQ_Maps"  "VassbergOvrSt_Maps" )
#-------------------------------------------------
## Map12: 003.07
#$!VarSet |Z| = ( |NumZones| + |Increment| )
#$!RUNMACROFUNCTION "AppendDataSetFile" ( '"|MACROFILEPATH|/../../../../DPW8-Scatter/TestCase2b/003_Boeing/07_FELight_HeldenMesh_Unstructured_REV00_SA-neg/DPW8-AePW4_ForceMoment_v6.dat"' )
#$!RUNMACROFUNCTION "AddLineMap" ( "SA_Maps" "HeldenUnSt_Maps" )
##-------------------------------------------------
## Map13: 003.08
#$!VarSet |Z| = ( |NumZones| + |Increment| )
#$!RUNMACROFUNCTION "AppendDataSetFile" ( '"|MACROFILEPATH|/../../../../DPW8-Scatter/TestCase2b/003_Boeing/08_FELight_Cadence_Unstructured_REV00_SA-neg/DPW8-AePW4_ForceMoment_v6.dat"' )
#$!RUNMACROFUNCTION "AddLineMap" ( "SA_Maps" "CadenceUnS_Maps" )
##-------------------------------------------------
## Map14: 003.09
#$!VarSet |Z| = ( |NumZones| + |Increment| )
#$!RUNMACROFUNCTION "AppendDataSetFile" ( '"|MACROFILEPATH|/../../../../DPW8-Scatter/TestCase2b/003_Boeing/09_OVERFLOW_Ames_Overset_REV00_SA-neg/DPW8-AePW4_ForceMoment_v6.dat"' )
...
$!LineMap  [5]  Symbols {SymbolShape {IsASCII = Yes ASCIIShape {                 FontOverride = UserDef ASCIIChar = '\b'}}}
$!LineMap  [6]  Symbols {SymbolShape {IsASCII = Yes ASCIIShape {UseBaseFont = No FontOverride = Greek   ASCIIChar = '\B'}}}
$!LineMap  [7]  Symbols {SymbolShape {IsASCII = Yes ASCIIShape {                 FontOverride = UserDef ASCIIChar = '\C'}}}
$!LineMap  [8]  Symbols {SymbolShape {IsASCII = Yes ASCIIShape {                 FontOverride = UserDef ASCIIChar = '\c'}}}
$!LineMap  [9]  Symbols {SymbolShape {IsASCII = Yes ASCIIShape {UseBaseFont = No FontOverride = Greek   ASCIIChar = '\C'}}}
...
$!Blanking Value { Constraint 1 { Include = Yes VarA = 6  RelOp = GreaterThan ValueCutoff = 4.30 } }
